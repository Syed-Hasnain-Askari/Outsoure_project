...
function TransDesign() {
  ...
  return (
    <>
            ...
            {topNav == false ? (
              <>
                <div className="icon_right_div row ">
                  <div
                    className="top_nav_container_right_content "
                    style={{ fontSize: "18px" }}
                  >
                    Help
                  </div>
      ...
      <div className={`main_nav ${navHeight && "nav_height"}`}>
        <div className="nav_container row">
          <div
            className={`responsive_sidebar ${
              responsiveSidebar && "responsive_sidebar_display"
            }`}
          >
            <div onClick={sideBar} className="close_menu">
              <AiOutlineClose />
            </div>
          ...
          <div className="nav_container_primary  row">
            <div
              className={`nav_content_ul row  ${
                isPrimaryMenuDisplay && "nav_content_hide"
              }`}
            >
            ...
            <div className="logo">
              <img
                className="logo_img"
                src="https://splonline.com.sa/Design/images/Logo.svg"
              ></img>
            </div>
            ...
            <div
              type="button"
              onClick={sideBar}
              className={`hammer ${isMobile && "hammer_display"}`}
            >
